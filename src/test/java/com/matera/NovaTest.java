...
public class NovaTest
{
    ...
    @Test
    public void testValorAumentadoDoImovelNovo() throws PrecoImovelMuitoBaixoException {
        Imovel novo = new Novo("rua whatever", 2_000.0);

        Assert.assertEquals(new Double(2000.0), novo.getPreco());
    }

    @Test
    public void testEnderecoResidencial() throws PrecoImovelMuitoBaixoException {
        Imovel novo2 = new Novo("Rua Santana",  356000.0);

        Assert.assertEquals("Rua Santana", novo2.getEndereco());
    }

    @Test
    public void testOrdemValoresResidenciasVelhas() throws PrecoImovelMuitoBaixoException {
        Novo novo1 = new Novo("Rua Santana", 56_000.0);
        Novo novo2 = new Novo("rua whatever", 21_000.0);
        Novo novo3 = new Novo("Rua Chile", 433_000.0);
        Novo novo4 = new Novo("rua fazer", 877_389.0);
        Novo novo5 = new Novo("Rua Viela", 557_000.0);
        Novo novo6 = new Novo("rua Pimba", 156_000.0);

        Novo novoa = new Novo("rua Pimba", 156_000.0);
        Novo novob = new Novo("rua Pimba", 969_696.0);
