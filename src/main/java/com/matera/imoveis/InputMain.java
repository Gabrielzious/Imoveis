...
public class InputMain{
    public static void main(String[] args) throws PrecoImovelMuitoBaixoException {

        List<Novo>  novos = new ArrayList<Novo>();



        Novo n1 = new Novo("Rua Nova X", 102000.0);
        Novo n2 = new Novo("Rua Nova J", 425000.0);
        Novo n3 = new Novo("Rua Nova R", 788000.0);
        Novo n4 = new Novo("Rua Nova P", 1390000.0);
        Novo n5 = new Novo("Rua Nova T", 290000.0);
        ...
        Velho v3 = new Velho("Rua velha A",3000);
